...
class TestBasisOperator(unittest.TestCase):
    ...
    def test_basis_operator_hash(self):
        ...
        self.assertIsNot(basis_operator_1, basis_operator_2)
...
class TestTerminalOperator(unittest.TestCase):
    ...
    def test_terminal_operator_hash(self):
        ...
        self.assertIsNot(terminal_operator_1, terminal_operator_2)
...
class TestSolution(unittest.TestCase):
    ...
    def test_solution_evaluate_result_caching(self):
        ...
        eval_func = mock.Mock(side_effect=[66.6])
    ...
    def test_solution_dominates(self):
        ...
        """
        eval_func_1 = mock.Mock(side_effect=[66.7, 66.6])
        eval_func_2 = mock.Mock(side_effect=[66.6, 66.6])
        eval_func_3 = mock.Mock(side_effect=[66.6, 66.6])
